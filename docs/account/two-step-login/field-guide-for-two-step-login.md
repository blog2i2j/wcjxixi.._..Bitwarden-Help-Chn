...
两步登录（也称为双重身份验证或 2FA）是网站和 App 常用的一种安全技术，用于保护您的敏感数据。使用两步登录的网站会要求您在输入用户名和密码之外，还要输入一个额外的「令牌」（也称为验证码或一次性密码 (OTP)）来验证您的身份，该令牌通常从不同的设备上获取。

如果没有辅助设备令牌的物理访问权限，恶意行为者即使知道了您的用户名和密码，他们也无法访问网站：

<div data-with-frame="true"><figure><img src="https://bitwarden.com/assets/6E6lpxB8UfXU7V6YcW40S3/b89a863ed448d1b90e42ac6c25140edd/fg-1.png?w=960&#x26;fm=avif" alt=""><figcaption><p>基本的两步登录流程</p></figcaption></figure></div>
...
通过在每次登录 Bitwarden 时除了输入主密码外，还要求一个附加步骤，来保护所有密码库数据。
...
启用两步登录将要求您在每次登录时，除了输入您的主密码外，还要完成一个附加步骤。解锁密码库时您无需完成附加步骤，仅登录时需要。

<div data-with-frame="true"><figure><img src="https://bitwarden.com/assets/1fc7ZMSHr1grocnEitdwua/1fbdceda08b4a6c59b17a96b366ffacd/fg-2.png?w=960&#x26;fm=avif" alt=""><figcaption><p>两步登录访问 Bitwarden</p></figcaption></figure></div>

Bitwarden 为免费版账户提供了多种两步登录方式，包括：

* FIDO（任何经过 FIDO2 WebAuthn 认证的钥匙）
* 验证器 App（如 [Bitwarden Authenticator](../../bitwarden-authenticator/bitwarden-authenticator.md)）
* 电子邮箱

对于高级版用户，Bitwarden 还提供了多种高级的两步登录方式：
...
<div align="left" data-with-frame="true"><figure><img src="https://bitwarden.com/assets/4ddS2XK3JVWe1uG9OCiXwB/d199bbf12b390ac32ec2a6737ded4a20/reddit-2fa-setup.png?w=600&#x26;fm=avif" alt=""><figcaption><p>2FA 二维码</p></figcaption></figure></div>
...
<div data-with-frame="true"><figure><img src="https://bitwarden.com/assets/kBDOyVjNB2DiINm7FHk0r/13b3f7bceb014df08b84246256451322/IMG_5440.png?w=1242&#x26;fm=avif" alt=""><figcaption><p>TOTP 令牌</p></figcaption></figure></div>

### 使用 Bitwarden Authenticator <a href="#use-bitwarden-authenticator" id="use-bitwarden-authenticator"></a>

Bitwarden Authenticator 是一款移动身份验证 App，您可以使用它在使用双重身份验证 (2FA) 的网站和 App 上验证您的身份。Bitwarden Authenticator 可以从 iOS App Store 和 Google Play Store 下载。

<div data-with-frame="true"><figure><img src="https://bitwarden.com/assets/5WsEwCqHd3BmAKTGdhXpQZ/bc84335eeb3655916781b1dd7cd4f4f1/fg-5.png?w=960&#x26;fm=avif" alt=""><figcaption><p>使用 Bitwarden Authenticator 进行两步登录</p></figcaption></figure></div>

有关使用 Bitwarden Authenticator 的帮助，请参阅[这篇文章](../../bitwarden-authenticator/bitwarden-authenticator.md)。

### 使用集成身份验证 <a href="#use-integrated-authentication" id="use-integrated-authentication"></a>

作为替代方案，Bitwarden Password Manager 为高版用户，包括付费版组织（家庭版、团队版或企业版）的成员，提供了一个内置的身份验证器。

<div data-with-frame="true"><figure><img src="https://bitwarden.com/assets/4XRROCzbnmkN2EM9iO7MLX/3cf42adb04c450c833cd7d8aad836665/fg-3.png?w=960&#x26;fm=avif" alt=""><figcaption><p>使用 Bitwarden 进行两步登录</p></figcaption></figure></div>
...
* [获取高级版以使用高级两步登录方式](https://vault.bitwarden.com/#/?premium=purchase)
