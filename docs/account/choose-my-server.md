...
Bitwarden Cloud 在全球范围内可用，并在**美国**和**欧盟**地区提供数据存储。

{% hint style="info" %}
Bitwarden 的数据区域是独立的，您的账户或组织仅存在于其最初创建的区域，这意味着：
...
* 账户创建后无法变更服务器。要从美国服务器切换到欧盟服务器（或反之），您必须在目标服务器上创建一个新账户。创建新账户后，您可以将现有密码库数据导出到新账户。
{% endhint %}
