...
{% embed url="https://bitwarden.com/assets/1XYC3HwXOTMAPvyW1GS3Mk/5c7833241844eded5fa119d44d6efebd/new-ssh.png?w=1400&fm=avif" %}
在桌面端创建新的 SSH 密钥
{% endembed %}
...
{% embed url="https://bitwarden.com/assets/1YnrhzwCw78KuFsArEioOO/b7db01ff5dbd209ebe30f6454275ba41/Share-ssh.png?w=1400&fm=avif" %}
共享 SSH 密钥
{% endembed %}
...
{% embed url="https://bitwarden.com/assets/5QTvyu39h3o0azkjU26P3t/77e877af88307d167daf0f292a38dd03/import-ssh.png?w=1254&fm=avif" %}
导入 SSH 密钥
{% endembed %}
