...
* **★从「我的密码库」转移项目到「我的项目」**：使用集中化组织所有权策略的组织现在可以[选择提示用户](admin-console/oversight-visibility/enterprise-policies.md#prompt-users-to-move-items-to-the-organization)使用浏览器扩展[将项目从「我的密码库」转移项目到「我的项目」](password-manager/organization-members/transfer-ownership.md)。
