...
* **Bitwarden Send 电子邮箱验证**：当用户创建 Send 时，他们可以选择验证接收者电子邮箱来保护它。[了解更多](password-manager/bitwarden-send/about-send.md)有关 Bitwarden Send 的信息。
...
* **扩展的新默认宽度**：浏览器扩展具有新的、更宽的默认宽度。。您可以[从外观菜单](password-manager/your-vault/appearance/change-app-appearance.md#liu-lan-qi-kuo-zhan)中切换回窄版界面或超宽版界面。
