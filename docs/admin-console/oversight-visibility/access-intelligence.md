...
{% embed url="https://bitwarden.com/assets/6ooDvXBHM0ehpTD2XWpQGK/88c0af7c5edd5b30b8037f49baf8ac88/2026-03-20_12-07-24.png?w=1146&fm=avif" %}
...
{% embed url="https://bitwarden.com/assets/4ors4hBI2rwbW0zvjb2W0U/70128699f9db718b6c99c5f0abcf241e/2026-04-08_09-29-26.png?w=1105&fm=avif" %}
访问 Access Intelligence 活动选项卡
{% endembed %}

* **风险随时间变化** ：可视化存在风险的应用程序、密码和成员随时间的变化情况，并将其与应用程序、密码和成员数量的绝对变化进行对比。
...
如果密码在组织内强度不足、已暴露或被重复使用，则该密码将被判定为**存在风险**。此分析使用与[弱密码报告](../../password-manager/your-vault/security-tools/vault-health-reports.md#weak-passwords-report) 、[已暴露密的码报告](../../password-manager/your-vault/security-tools/vault-health-reports.md#exposed-passwords-report)和[重复使用的密码报告](../../password-manager/your-vault/security-tools/vault-health-reports.md#reused-passwords-report)中相同的工具进行。与手动运行报告一样，Access Intelligence 的分析也是在本地完成的，以维持零知识并保护您的数据完整性和匿名性。
...
{% embed url="https://bitwarden.com/assets/77hdEeJiKWpHd8BoHYbnCx/e691c69651cace09523a8655e31e3988/2026-03-20_12-09-56.png?w=1146&fm=avif" %}
标记关键应用程序
{% endembed %}
...
{% embed url="https://bitwarden.com/assets/6wQ3EUzMFkzRIkA2FHgnlY/99836bd7d0bd053e1c2eb6878175685c/2026-03-20_12-07-242.png?w=1146&fm=avif" %}
请求密码更改
{% endembed %}
